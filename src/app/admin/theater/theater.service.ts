...
export class TheaterService {
  ...
  private readonly API_URL_THEATERNAME = 'http://localhost:8080/theatreName?id=';
  ...
  getTheaterName(id): Observable<Theatre>{
    return this.http.get<Theatre>(this.API_URL_THEATERNAME + id);
  }
